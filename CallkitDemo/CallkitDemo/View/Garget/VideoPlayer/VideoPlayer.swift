...
private struct InternalVideoPlayer<Content : View> : UIViewControllerRepresentable {
    typealias UIViewControllerType = VideoPlayerWrapperVideController<Content>
    
    func makeUIViewController(context: UIViewControllerRepresentableContext<InternalVideoPlayer>) -> VideoPlayerWrapperVideController<Content> {
        let controller = UIViewControllerType()
        controller.player = player
        return controller
    }
    
    func updateUIViewController(_ uiViewController: VideoPlayerWrapperVideController<Content>, context: UIViewControllerRepresentableContext<InternalVideoPlayer>) {
